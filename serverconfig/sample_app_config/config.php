...
|
*/
$config['domain'] = 'edoc.jaymart.co.th';
...
|
*/
$config['encryption_key'] = 'YmAH8466hisMhis';
...
$config['csrf_token_name'] = 'csrf_ntksoftware_name';
...
if (strpos($_SERVER['REQUEST_URI'], "/ajax_relation")!==FALSE)
{
