  ...
  // <script>
    ...
    AutoComplete.prototype = {
        ...
        render: function (item) {
            return '<li>' +
                        '<a href="javascript:;"><span class="fa fa-user"></span> <span class="usermention">' + item[this.options.queryBy] + '</span></a>' +
                    '</li>';
        },
...
//        	return "<p class='usermention' id='usermendtioned-"+item[this.options.queryBy]+"-endusermendtioned'>&#160;"+item[this.options.queryBy]+"</p>";
            //return '<span class="fa fa-user"></span> <span>' + item[this.options.queryBy] + '</span>&nbsp;';
        	 return "<p class='usermention' id='usermendtioned-"+item[this.options.queryBy]+"-endusermendtioned'>&#160;<a href='javascript:;'><span id='doc-type' class='glyphicon glyphicon-user' aria-hidden='true'></span><span class='fa fa-user'></span> <span class='usermention'>&#160;"+item[this.options.queryBy]+"</span></a></p>";
        },
