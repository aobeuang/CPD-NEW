<?php
    $this->set_css($this->default_theme_path.'/bootstrap_new_brand/css/bootstrap/bootstrap.min.css');
    $this->set_css($this->default_theme_path.'/bootstrap_new_brand/css/font-awesome/css/font-awesome.min.css');
    $this->set_css($this->default_theme_path.'/bootstrap_new_brand/css/common.css');
    $this->set_css($this->default_theme_path.'/bootstrap_new_brand/css/general.css');
    $this->set_css($this->default_theme_path.'/bootstrap_new_brand/css/add-edit-form.css');

    if ($this->config->environment == 'production') {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        $this->set_js_lib($this->default_theme_path.'/bootstrap_new_brand/build/js/global-libs.min.js');
        $this->set_js_config($this->default_theme_path.'/bootstrap_new_brand/js/form/add.js');
    } else {
        $this->set_js_lib($this->default_javascript_path.'/'.grocery_CRUD::JQUERY);
        $this->set_js_lib($this->default_theme_path.'/bootstrap_new_brand/js/jquery-plugins/jquery.form.min.js');
        $this->set_js_lib($this->default_theme_path.'/bootstrap_new_brand/js/common/common.min.js');
        $this->set_js_config($this->default_theme_path.'/bootstrap_new_brand/js/form/add.js');
    }
...
<script>
	...
	var list_url = '<?php echo site_url()?>';
