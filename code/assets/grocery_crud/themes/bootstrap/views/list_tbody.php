        ...
        <td <?php if ($unset_delete) { ?> style="border-left: none;"<?php } ?>
            <?php if ($buttons_counter === 0) {?>class="hidden"<?php }?>>
                <div class="only-desktops"  style="white-space: nowrap">
                    <?php if(!$unset_edit){?>
                        <a class="" href="<?php echo $row->edit_url?>"><img src="/assets/default/images/edit-495057.png" width="12px"> <?php echo $this->l('list_edit'); ?></a>
                    <?php } ?>
                    <?php if (!empty($row->action_urls) || !$unset_read || !$unset_delete) { ?>

                        <?php if ($show_more_button) { ?>
                            <div class="dropdown l10 r10" style="display: inline-block;">
                                <!-- <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                    <?php echo $more_string; ?>
                                    <span class="caret"></span>
                                </button> -->
                                <a href="" class="dropdown-toggle" data-toggle="dropdown"><img src="/assets/default/images/more.png" width="14px"></a>
                                <ul class="dropdown-menu" style="margin-top: 0px;right: 0;left: auto;">
                                    <?php
                                    ...
                                    <?php if (!$unset_read) { ?>
                                        <li>
                                            <a href="<?php echo $row->read_url?>"><img src="/assets/default/images/eye-495057.png" width="12px"> <?php echo $this->l('list_view')?></a>
                                        </li>
                                    <?php } ?>
                                    <?php if (!$unset_delete) { ?>
                                        <li>
                            ...
                            <?php } else {
                                ...
                                if (!$unset_read) { ?>
                                    <a class="blue" href="<?php echo $row->read_url?>"><img src="/assets/default/images/eye-495057.png" width="12px"></i> <?php echo $this->l('list_view')?></a>
                                <?php }
                ...
                <div class="only-mobiles">
                    ...
                    <div class="btn-group dropdown">
                        <button type="button" class="dropdown-toggle" data-toggle="dropdown" style="color: "#495057;>
