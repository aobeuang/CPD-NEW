    ...
    function drawType(jsonData) {
        try{
            ...
            for(var i=0;i<jsonData.length;i++)
            {
                ...
                var temp = [];
                console.log(jsonData[i].TYPE+ '-->' + jsonData[i].RAI);

                temp.push(jsonData[i].TYPE);
...
<!--		<div id="main-container" class="container-fluid col-md-12 col-xs-12" >-->
			...
			<div style="position: relative;">
			   	<h2  class="report-title-center" style="text-align:center"><center>รายงานทะเบียนเกษตรกร จำนวนพื้นที่ของสมาชิกสหกรณ์</center></h2>
<!-- 				<h4><center>จำนวนสมาชิกของสหกรณ์   <span id="total"></span> คน</center></h4> -->
            ...
            <div class="row" ng-show="resultListType.length > 0">

                <center><h2  class="report-title-center" style="text-align:center; margin-top: 10px">ข้อมูลพื้นที่ตามประเภท</h2></center>
                <div id="table_div" style="display: block; margin-left: auto; margin-top: 10px;  margin-right: auto;  width: 80%;" class="text-center" >
                    <table class="table table-bordered table-condensed table-data table-striped table-hover">
                        ...
                        <tr ng-repeat="row in resultListType track by $index">
                            <td>
                                {{$index + 1}}
                            </td>
