...
<script language="javascript">
	    	   ...
	    	   $("#pageLoading").fadeOut();
	    	   	if(result.items != null){
	    	   		if(result.items == 'nopermission'){
						...
						var address = result.items[0].hno+' '+result.items[0].road+' '+result.items[0].subd+' '+result.items[0].district;
	...
	function getUserListByName()
	{
		...
		$.ajax({
	        ...
	        success:function(result){
	    	   $('#data_respone').html(result.data.query);
	    	   $("#pageLoading").fadeOut();
