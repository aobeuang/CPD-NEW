...
// 						$('#tab5_a1_problem').prop('checked', false); 
        ...
        <div class="row">
            ...
            <script type="text/javascript">
                 $(".tab5_a3").css('display','none');
				function tab5_a3(value){
					if(value)
					{
						$(".tab5_a3").prop('disabled', false);
                        $(".tab5_a3").css('display','block');
					}else{
        ...
        <div class="row">
			...
			<script type="text/javascript">
                $(".tab5_a5").css('display','none');
				function tab5_a5(value){
					if(value)
					{
						$(".tab5_a5").prop('disabled', false);
                        $(".tab5_a5").css('display','block');
					}else{
...
<div class="row mar_ned" style="padding: 0 15px;">
 ...
 <div class="col-md-12 col-xs-9">
        ...
        <div class="row">
            ...
            <script type="text/javascript">
                $(".tab5_a8").css('display','none');
				function tab5_a8(value){
					if(value)
					{
						$(".tab5_a8").prop('disabled', false);
                        $(".tab5_a8").css('display','block');
					}else{
		...
		?>
            ...
            <script type="text/javascript">
                $(".tab5_a10").css('display','none');
				function tab5_a10(value){
					if(value)
					{
						$(".tab5_a10").prop('disabled', false);
                        $(".tab5_a10").css('display','block');
					}else{
        ...
        <div class="row">
 		...
 		<script type="text/javascript">
                $(".tab5_a11").css('display','none');
				function tab5_a11(value){
					if(value)
					{
						$(".tab5_a11").prop('disabled', false);
                        $(".tab5_a11").css('display','block');
					}else{
