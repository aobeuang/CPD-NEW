		...
		<div class="report-result">
			...
			<!-- <h2><span class="glyphicon glyphicon-stats"></span> รายงานจำนวนสมาชิกสหกรณ์ ภาคเกษตร</h2> -->
			    ...
			    <a onclick="downloadExcel();" id="save-pdf" class="btn btn-save-dl floatR" style="position: absolute;right: 15px;">
			   	...
			   	<h2  class="report-title-center" style="text-align:center"><center>รายงานจำนวนสมาชิกสหกรณ์ ภาคเกษตร</center></h2>
...
function drawType1() {
	...
	btnSave.addEventListener('click', function () {
		...
		var docDefinition = { 
				content: [
					{
						text: 'รายงานจำนวนสมาชิกสหกรณ์ ภาคการเกษตร',
						alignment: 'center',
						style: 'header'
					},
					{
		...
		pdfMake.createPdf(docDefinition).download('รายงานจำนวนสมาชิกสหกรณ์ ภาคการเกษตร.pdf');
	  }, false);
