	 		...
	 		<div style="width:100%;float:left;">
				...
				*/ ?>
							...
							<div>
								...
								<button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="save-and-go-back-button" style="margin-top: -2px;">
				...
				*/ ?>
							...
							<div>
								...
								<button class="btn btn-outline-success my-2 my-sm-0" type="submit" id="searchname" style="margin-top: -2px;">
								<span class="glyphicon glyphicon-search"></span>
