...
<h2 class="tab-title">การปลูกพืชและเลี้ยงสัตว์</h2>
...
<!-- Read more: https://html.com/tables/rowspan-colspan/#ixzz5JvI82H48 -->
           ...
           // echo "<pre>"; print_r($user_survey_data);
            ...
            <tr>
                ...
                <td>
                    <select style="width: 148px;" name="plant_type[]"  class="plant_type1" >
                ...
                <td style="text-align:  center;">
					...
					if (empty($plant_sell_merchant[$ir]))
						$plant_sell_merchant[$ir] = "0";
					?>
					<input onclick="" type="checkbox" class="" name="plant_sell_merchantxxx[]" value="1" <?php if(isset($plant_sell_merchant[$ir]) && $plant_sell_merchant[$ir]==1){ echo "checked"; } ?> />
                ...
                <td style="text-align:  center;">                
                	<?php $plant_sell_coop[$ir] = isset( $plant_sell_coop[$ir]) ?  $plant_sell_coop[$ir]: 0;
	                	if (empty($plant_sell_coop[$ir]))
	                		$plant_sell_coop[$ir] = "0";
	                	
                	?>
                	<input onclick="" type="checkbox" class="" name="plant_sell_merchantxxx[]" value="1" <?php if(isset($plant_sell_coop[$ir]) && $plant_sell_coop[$ir]==1){ echo "checked"; } ?> />
                ...
                <td style="text-align:  center;">
                	<?php $plant_sell_other[$ir] = isset( $plant_sell_other[$ir]) ?  $plant_sell_other[$ir]: 0;
		                	if (empty($plant_sell_other[$ir]))
		                		$plant_sell_other[$ir] = "0";
                	?>
                	
                	<input onclick="" type="checkbox" class="" name="plant_sell_merchantxxx[]" value="1" <?php if(isset($plant_sell_other[$ir]) && $plant_sell_other[$ir]==1){ echo "checked"; } ?> />
