...
<h2 class="tab-title">พื้นที่ครอบครอง</h2>
...
<?php
            ...
            <tr>
                ...
                <td >
                	<select id="own_land_type" name="own_land_type[]" class="select-feild">               	
                ...
                <td >
                	<select id="land_type" name="own_land_type_type[]" class="select-feild">
...
<?php
	...
	<div class="row">
            <div class="col-md-12 col-xs-12">
                <label>
                    <stong> มีแหล่งน้ำที่ใช้ในการเกษตร</stong>
                </label>
            </div>
