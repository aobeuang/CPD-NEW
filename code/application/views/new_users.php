        ...
        <div class="container-fluid col-md-12 col-xs-12">
            <div class="row form-result registration-form">
                <div class="form-result-header">
                           <span> เพิ่มผู้ใช้งานระบบ</span><span style="float: right;">Page Code : MNG002</span>   </div>
                ...
                <form method="post" id="add_users" class="col-sm-offset-2 col-sm-8">
                    <div class="form-group">
                    	...
                    	<div class="col-sm-9">
        	                <input type="text" class="form-control item" id="username" maxlength="13" placeholder="ชื่อผู้ใช้งาน" autocomplete="off">                    
                    ...
                    <div class="form-group">
                    	...
                    	<div class="col-sm-9">
                        <input type="password" class="form-control item" id="password" minlength="4" placeholder="รหัสผ่าน" autocomplete="new-password">
