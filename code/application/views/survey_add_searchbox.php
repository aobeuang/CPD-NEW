...
<div id="main-wrapper">
	<div id="main-container" class="row report-result">
			    ...
			    <div class="row">
					...
					<div class="container-fluid col-md-12" >
						...
						<div class="form-group col-md-12">
							...
							<button class="btn btn-outline-purple my-2 my-sm-0" type="submit" id="save-and-go-back-button">
									...
									<?php
									    ...
									    foreach ($coops as $k=>$v):?>
									    	...
									    	<?php if (!in_array($v['REGISTRY_NO_2'], $already_have)):?>
									    		<li style="background-color:#E5EEF4;padding-top:8px;padding-bottom:8px;padding-left:16px;width:90%;margin-top: 3px;">
												...
												<?php if (in_array($v['REGISTRY_NO_2'], $existing_coop_surveys)):?>
													...
													<?php if (canViewSurveyByCoop($v['REGISTRY_NO_2'])):?>
														...
														<a href="<?php echo site_url("admin/do_survey_1")?>/<?php echo urlencode($citizen_id)?>/?coop=<?php echo $v['REGISTRY_NO_2']?>&step=1&&org=<?php echo $v['ORG_ID']?>&citizen_id=<?php echo urlencode($citizen_id)?>"><span class="glyphicon glyphicon-edit"></span> <?php echo $v['COOP_NAME_TH']?> <?php echo $v['PROVINCE_NAME']?>						
															(มีการทำแบบสำรวจแล้ว)
														</a>
													
													<?php else:?>
													
														<a href="#" class="nopermission"><span class="glyphicon glyphicon-eye-close"></span> <?php echo trim($v['COOP_NAME_TH'])?>, <?php echo $v['PROVINCE_NAME']?>						
						...
						<div class="" >
						    <div class="row">
						    	<div class="container-fluid col-md-12 col-xs-12" >
								<lable for id="coop_member_id" style="color:red">ไม่พบข้อมูลสหกรณ์ที่เป็นสมาชิกในฐานข้อมูลสมาชิก!!</lable><br/>
									<a href="<?php
									$citizen_id = "";
									if(isset($_GET['citizen_id'])){ $citizen_id =  $_GET['citizen_id']; }
									echo site_url("admin/do_survey_1/".$citizen_id."/?citizen_id=".$citizen_id."&step=1")?>">
										<i class="glyphicon glyphicon-plus"></i><span style="font-size: 16px;font-weight:600;"> เพิ่มแบบสำรวจโดยกรอกข้อมูลสมาชิกเอง</span>
									</a>
									
									<br/><br/><br/>
									<?php if (!empty($surveys)):?>
										<label style="font-size: 16px;font-weight:600;">พบข้อมูลแบบสอบถามสมาชิกดังนี้</label>
										...
										<ul style="list-style: none;list-style: none;padding-left: 0;margin-top:20px">
											...
											<li style="background-color:#E5EEF4;padding-top:8px;padding-bottom:8px;padding-left:16px;width:90%;margin-top: 3px;">
												...
												<a href="<?php echo site_url("admin/do_survey_1")?>/<?php echo $citizen_id?>/?coop=<?php echo $coop['REGISTRY_NO_2']?>&mode=view&org=<?php echo $coop['ORG_ID']?>&step=1"><label><?php echo $coop['COOP_NAME_TH']?></label></a>
												<br/>
