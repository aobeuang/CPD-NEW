...
<div id="report" class="nonmis">
	...
	<div id="main-wrapper">
		...
		<div id="main-container" class="container-fluid col-md-12 col-xs-12">
			...
			<ul class="list-group">
				<li class="list-group-item active"><a href="<?php echo site_url('report1/index1')?>">รายงานข้อมูลทั่วไป</a></li>
			...
			<div id="right-container" class="col-md-12 col-xs-12">
				...
				<div class="row" id="action-bar">
					<div class="report-action-bar">
						...
						<div class="container-fluid col-md-4 col-xs-12"  style="margin-top: 6px;">				
							...
							<option value = "0" >ทั้งหมด </option>
								<?php foreach ($all_provinces as $province):?>
									...
									<option value="<?php echo $province->PROVINCE_ID?>"  data-target="<?php echo $province->PROVINCE_NAME?>"<?php // echo $selected?> ><?php echo $province->PROVINCE_NAME?></option>
								<?php endforeach?>
							</select>
						...
						<div class="container-fluid col-md-1 col-xs-12" class="search-report-button" style="">
						...
						<div class="container-fluid col-md-4 col-xs-12"  style="margin-top: 6px;">				
							...
							<?php $listfilter_status= array("ทำธุรกิจกับสหกรณ์/กลุ่มเกษตร","สถานภาพ","ระดับการศึกษา");?>							
...
function drawType1(filter_year,filter_province_hidden,filter_range_income_hidden,filter_status) {
  ...
  google.visualization.events.addListener(chart, 'ready', function () {
	...
	btnSave.addEventListener('click', function () {
		...
		pdfMake.createPdf(docDefinition).download('รายงานข้อมูลทั่วไป.pdf');
	  }, false);
...
function call_ajax(filter_year,filter_province_hidden,filter_range_income_hidden)
{
	...
	if(filter_status == 0){
		filter = 'type_business';
	}
	if(filter_status == 1){
		filter = 'family_status_report';
	}
	if(filter_status == 2){
